...
import '../controllers/recent_news_controller.dart';

class RecentNewsView extends GetView<RecentNewsController> {
  // final _controller = Get.put(RecentNewsController());
  final _networkServiceController = Get.put(NetworkServiceController());
  RecentNewsView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<RecentNewsController>(
      init: Get.put(RecentNewsController()),
      builder: (_controller) {
        return Obx(
          () => SafeArea(
                                          ...
                                          case 1:
                                            return Row(
                                              children: [
                                                Expanded(
                                                    child:
                                                        SmallVerticalNewsCard(
                                                  newsResult: _controller
                                                      .newsList[index],
                                                  imageUrl: _controller
                                                      .newsList[index]
                                                      .titlePhoto!,
